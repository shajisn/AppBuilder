...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<Nav> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, ArrayList<Nav>> _listDataChild;

    public ExpandableListAdapter(Context context, ArrayList<Nav> listDataHeader,
                                 HashMap<String, ArrayList<Nav>> listChildData) {
    ...
    public int getChildrenCount(int groupPosition) {
        return this._listDataChild.get(this._listDataHeader.get(groupPosition).getId()) != null ? this._listDataChild.get(this._listDataHeader.get(groupPosition).getId()).size() : 0;
    }
